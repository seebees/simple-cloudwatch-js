...
test('with units and dimensions', function(t) {
  if (con.proxy) {
    var scope = nock('https://monitoring.amazonaws.com')
                  ...
                  .get( '/?AWSAccessKeyId=YOUR-KEY-HERE'
                      ...
                      + '&MetricData.member.1.Dimensions.member.1.Value=Big'
                      + '&MetricData.member.1.Dimensions.member.2.Name=App'
                      + '&MetricData.member.1.Dimensions.member.2.Value=small'
                      + '&Signature=YYY')
                  .reply(200
